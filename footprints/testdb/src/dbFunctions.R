...
getDBConnection <- function(database) {
  ...
  if (database == "trenatest") {
  ...
  } else if (database == "adrenal_gland_wellington_16_localhost") {
    user = "trena"
    password = "trena"
    dbname = "adrenal_gland_wellington_16"
    host = "localhost"    
  } else if (database == "adrenal_gland_hint_16_localhost") {
    user = "trena"
    password = "trena"
  ...
  } else if (database == "bronchus_wellington_16_localhost") {      
    user = "trena"
    password = "trena"
    dbname = "bronchus_wellington_16"
    host = "localhost"    
  } else if (database == "bronchus_hint_16_localhost") {
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "extraembryonic_structure_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    dbname = "extraembryonic_structure_wellington_20"
    host = "localhost"

  } else if (database == "extraembryonic_structure_hint_16_localhost") {      
    user = "trena"
    password = "trena"
    dbname = "extraembryonic_structure_hint_16"
    host = "localhost"
  } else if (database == "extraembryonic_structure_wellington_16_localhost") {      
    user = "trena"
    password = "trena"
    dbname = "extraembryonic_structure_wellington_16"
    host = "localhost"

  } else if (database == "eye_hint_20_localhost") {
    user = "trena"
    password = "trena"
    dbname = "eye_hint_20"
    host = "localhost"
  } else if (database == "eye_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "gonad_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "heart_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "kidney_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "large_intestine_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "liver_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    dbname = "lung_hint_20"
    host = "localhost"
  } else if (database == "lung_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "lymphatic_vessel_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
  ...
  } else if (database == "mammary_gland_hint_20_localhost") {
    user = "trena"
    password = "trena"
    dbname = "mammary_gland_hint_20"
    host = "localhost"
  } else if (database == "mammary_gland_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "mouth_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "muscle_organ_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "pancreas_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "prostate_gland_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
  ...
  } else if (database == "spinal_cord_hint_20_localhost") {
    user = "trena"
    password = "trena"
    dbname = "spinal_cord_hint_20"
    host = "localhost"
  } else if (database == "spinal_cord_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "stomach_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "thyroid_gland_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"
  } else if (database == "tongue_wellington_20_localhost") {      
    user = "trena"
    password = "trena"
    ...
    host = "localhost"    
  } else if (database == "urinary_bladder_wellington_20_localhost") {
    user = "trena"
    password = "trena"

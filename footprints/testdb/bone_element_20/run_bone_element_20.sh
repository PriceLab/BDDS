...
create database bone_element_wellington_20;
grant all privileges on database bone_element_wellington_20 to trena;
create database bone_element_hint_20;
grant all privileges on database bone_element_hint_20 to trena;

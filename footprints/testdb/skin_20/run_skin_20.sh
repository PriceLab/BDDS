...
create database skin_wellington_20;
grant all privileges on database skin_wellington_20 to trena;
create database skin_hint_20;
grant all privileges on database skin_hint_20 to trena;

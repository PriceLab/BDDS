...
create database lymphoblast_wellington_16;
grant all privileges on database lymphoblast_wellington_16 to trena;
create database lymphoblast_hint_16;
grant all privileges on database lymphoblast_hint_16 to trena;
